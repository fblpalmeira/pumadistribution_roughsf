...
mapa<-roughsf::roughsf(list(puma, mundi),
                 title = "Distribuiton of Puma: a widely distributed felid in the world", caption = "Data: IUCN Red List | Image credit: @PhyloPic | Visualization by @fblpalmeira",
                 title_font = "40px Pristina", font = "30px Pristina", caption_font = "30px Pristina",
